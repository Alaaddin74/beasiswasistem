        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                <img class="w-8 h-8 mr-2 rounded-full"
                    src="https://img.freepik.com/premium-vector/education-logo-icon-design-vector-illustration_1094201-561.jpg"
                    alt="logo">
                Beasiswa
            </a>
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form action="{{ route('register.post') }}" method="post" class="space-y-4 md:space-y-6">
                        ...
                        <div>
                            <label for="name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">The name</label>
